;(function(window) {
    ...
    function Animocon(el, options) {
        ...
        this.el.addEventListener(clickHandler, function() {
            ...
            if(el.className.indexOf('praise-ok') > -1) {
                self.checked = true;
    ...
    function anim1(el1, el1span) {
        ...
        new Animocon(el1, {
            ...
            onUnCheck : function() {
                el1.style.color = 'rgb(255,202,75)';
            }
        });
        /* Icon 1 */
    }
    function anim2(el2, el2span) {
        ...
        new Animocon(el2, {
            ...
            onUnCheck : function() {
                el2.style.color = 'rgb(255,202,75)';
            }
        });
        /* Icon 2 */
    }
    function anim3(el3, el3span) {
        ...
        new Animocon(el3, {
            ...
            onCheck : function() {
                el3.style.color = 'rgb(255, 199, 65)';
            },
            onUnCheck : function() {
        ...
        new Animocon(el4, {
            tweens : [
                ...
                new mojs.Burst({
                    ...
                    duration: 1500,
                    shape : 'circle',
                    fill : [ 'rgb(255,202,75)', '#DE8AA0', '#8AAEDE', '#8ADEAD', '#DEC58A', '#8AD1DE' ],
                    x: '50%',
                    y: '50%',
                    opacity: 0.6,
            ...
            onCheck : function() {
                el4.style.color = 'rgb(255,202,75)';
            },
            onUnCheck : function() {
    ...
    function anim5(el5, el5span) {
        ...
        new Animocon(el5, {
            ...
            onCheck : function() {
                el5.style.color = 'rgb(255,202,75)';
            },
            onUnCheck : function() {
    ...
    function anim6(el6, el6span) {
        ...
        new Animocon(el6, {
            ...
            onCheck : function() {
                el6.style.color = 'rgb(255,202,75)';
            },
            onUnCheck : function() {
    ...
    function anim7(el7, el7span) {
        ...
        new Animocon(el7, {
            ...
            onCheck : function() {
                el7.style.color = 'rgb(255,202,75)';
            },
            onUnCheck : function() {
    ...
    function anim8(el8, el8span) {
        ...
        new Animocon(el8, {
            ...
            onCheck : function() {
                el8.style.color = 'rgb(255,202,75)';
            },
            onUnCheck : function() {
    ...
    function anim9(el9, el9span) {
        ...
        new Animocon(el9, {
            ...
            onCheck : function() {
                el9.style.color = 'rgb(255,202,75)';
            },
            onUnCheck : function() {

...
snippet docs - create a comment to describe your code\n\
	...
	'''\n\
snippet while - while some condition is True, keep looping over some code\n\
	while ${1:condition}:\n\
		${2:# TODO: write code...}\n\
snippet with - do stuff with something assigned to a name\n\
	with ${1:something} as ${2:name}:\n\
		${3:# TODO: write code...}\n\
# New Class\n\
snippet class - create a new class that defines the behaviour of a new type of object\n\
